...
test_mapToAlignments <- function() {
    ...
    ## reverse = FALSE 
    ans <- mapToAlignments(GR_1, GA_1, FALSE)
    ...
    ans <- mapToAlignments(GR_2, GA_2, TRUE)
...
test_pmapToAlignments <- function() {
    ...
    ans <- pmapToAlignments(GR_1, GA_1P, FALSE)
    ...
    ans <- pmapToAlignments(GR_2P, GA_3, FALSE)
    ...
    ## reverse = TRUE 
    GA_1P <- rep(GA_1[1], length(GR_1))
    ans <- pmapToAlignments(GR_1, GA_1P, TRUE)
    ...
    ans <- pmapToAlignments(GR_2P, GA_2, TRUE)
