...
BAM file {\tt untreated1\_chr4.bam} (located in the `r Biocpkg("pasillaBamSubset")` data package) contains single-end reads from the
...
BAM file {\tt untreated3_chr4.bam} (located in the `r Biocpkg("pasillaBamSubset")` data package) contains paired-end reads from the
